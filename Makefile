...
# 源文件和目标文件
SOURCES = main.cpp maze.cpp pathfinder.cpp visualizer.cpp
...
# 依赖关系
main.o: main.cpp maze.h pathfinder.h visualizer.h
maze.o: maze.cpp maze.h
pathfinder.o: pathfinder.cpp pathfinder.h maze.h
visualizer.o: visualizer.cpp visualizer.h maze.h pathfinder.h
